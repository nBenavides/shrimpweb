...
public class AnxVentaElectronica implements Serializable {
	...
	@ManyToOne
	@JoinColumns({
			@JoinColumn(name = "vta_empresa", referencedColumnName = "vta_empresa", nullable = false),
			@JoinColumn(name = "vta_motivo", referencedColumnName = "vta_motivo", nullable = false),
			@JoinColumn(name = "vta_numero", referencedColumnName = "vta_numero", nullable = false),
			@JoinColumn(name = "vta_periodo", referencedColumnName = "vta_periodo", nullable = false) })
	private InvVenta invVenta;
	...
	public InvVenta getInvVenta() {
		return invVenta;
	}

	public void setInvVenta(InvVenta invVenta) {
