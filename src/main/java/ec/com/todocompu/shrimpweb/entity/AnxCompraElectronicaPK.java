...
/**
 * The primary key class for the anx_compra_electronica database table.
 * 
 */
@Embeddable
public class AnxCompraElectronicaPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof AnxCompraElectronicaPK)) {
			return false;
		}
		AnxCompraElectronicaPK castOther = (AnxCompraElectronicaPK)other;
		return 
